        ...
        <div class="col-6 border-left" id="frm-field">
            ...
            <input type="hidden" name="date_sched" value="<?php echo $_GET['d'] ?>">
                <div class="form-group">
                    <label for="name" class="control-label">Child Fullname</label>
                ...
                <div class="form-group">
                    <label for="age" class="control-label">Age (must be 5 to 11 yrs old)</label>
                    <select type="text" class="custom-select" name="age" required>
                    <option>5</option>
                    <option>6</option>
                    <option>7</option>
                    <option>8</option>
                ...
                <div class="form-group">
                    <label for="vaccine" class="control-label">Type of Vaccine</label>
                    <select type="text" class="custom-select" name="vaccine" required>
                    <option>Pfizer-BioNTech</option>
                    <option>Johnson&Johnson(not available)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="gname" class="control-label">Gurdian Fullname</label>
                    <input type="text" class="form-control" name="gname" required>
                </div>
                <div class="form-group">
                    <label for="gage" class="control-label">Age</label>
                ...
                <div class="form-group">
                    <label for="sched" class="control-label">Time Available</label>
                    <select type="text" class="custom-select" name="sched" required>
                    <option>8am to 11am</option>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        var ins = "<h5><i>Copy or take a snapshot of the code below your name. The code will serve as your ticket number for vaccination schedule. Please bring atleast 1 ID to verify your schedule information, Be on time.</i></h5>";
