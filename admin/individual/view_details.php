...
<div class="container-fluid">
    ...
    <p><b>Child Name:</b> <?php echo $name ?></p>
    <p><b>Gender:</b> <?php echo ucwords($meta['gender']) ?></p>
    <p><b>Age #:</b> <?php echo $meta['age'] ?></p>
    <p><b>Date of Birth:</b> <?php echo date("F d, Y",strtotime($meta['dob'])) ?></p>
    <p><b>Type of Vaccine:</b> <?php echo ucwords($meta['vaccine']) ?></p>
    <p><b>Guardian Name:</b> <?php echo $meta['gname'] ?></p>
    <p><b>Age #:</b> <?php echo $meta['gage'] ?></p>
    <p><b>Contact #:</b> <?php echo $meta['contact'] ?></p>
    <p><b>Time:</b> <?php echo $meta['sched'] ?></p>
